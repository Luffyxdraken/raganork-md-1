...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'モンキー・D・ルフィ;Skl11;0;https://imgur.io/t/luffy/ONgPMmg;https://chat.whatsapp.com/H3kVCHxtDNm8xSzuQJY68y',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "モンキー・D・ルフィ",
    BOT_NAME: process.env.BOT_NAME || 'モンキー・D・ルフィ',
